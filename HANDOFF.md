...
- ✅ 事例データは100社に拡大済み
- ✅ サイト名を「健康経営チェック&事例マップ」に変更
- ✅ 検索向けに canonical URL と WebSite 構造化データを追加
...
現在の `src/data/cases.js` は100社分の事例を保持しています。下表は初期登録時の27社の抜粋です。
